...
def attack(char_name, char_class):
    if char_class == 'warrior':
        return (
            f'{char_name}'
            f'нанёс урон противнику равный {DEFAULT_DAMAGE + randint(3, 5)}'
        )
    if char_class == 'mage':
        return (
            f'{char_name}'
            f'нанёс урон противнику равный {DEFAULT_DAMAGE + randint(5, 10)}'
        )
    if char_class == 'healer':
        return (
            f'{char_name}'
            f'нанёс урон противнику равный {DEFAULT_DAMAGE + randint(-3, -1)}'
            )
...
def defence(char_name, char_class):
    if char_class == 'warrior':
        return (
            f'{char_name} блокировал {DEFAULT_DEFENCE + randint(5, 10)} урона'
        )
    if char_class == 'mage':
        return (
            f'{char_name} блокировал {DEFAULT_DEFENCE + randint(-2, 2)} урона'
        )
    if char_class == 'healer':
        return (
            f'{char_name} блокировал {DEFAULT_DEFENCE + randint(2, 5)} урона'
        )
